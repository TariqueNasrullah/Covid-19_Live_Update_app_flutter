...
//                    width: MediaQuery.of(context).size.width * 0.35,
                  padding:
                      EdgeInsets.only(top: 20, bottom: 5, left: 10, right: 15),
...
Future<List<CountryData>> fetchCountryData() async {
  ...
  try {
    final response = await http.get("http://34.87.85.112:8080/countryDataList/",
        headers: headers);
